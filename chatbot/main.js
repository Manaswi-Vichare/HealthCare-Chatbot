...
scrollTop:$("#conversation.message-body:last-child").position().top,
    ...
    $.fn.startOver = function () {
      ...
      $("#conversation").empty();
      const text =
        "Welcome! I'm HealthCare Chatbot. What symptoms are you currently experiencing?\n When you've entered all of your symptoms, please write '<b>Done</b>'.";
      $("#conversation").append(
    ...
    $.fn.appendUserMessage = function () {
      var text = input.val();
      $("#conversation").append(
        `<div class="row message-body"><div class="col-sm-12 message-main-sender"><divclass="sender"><divclass="message-text">${text}</div></div></div></div>`
      );
    };
